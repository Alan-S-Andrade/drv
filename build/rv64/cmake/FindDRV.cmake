set(GNU_RISCV_TOOLCHAIN_PREFIX /users/alanuiuc/local/riscv)
set(SST_CORE_PREFIX /users/alanuiuc/local/sstcore)
set(SST_ELEMENTS_PREFIX /users/alanuiuc/local/sstelements)
set(DRV_INSTALL_PREFIX /usr/local/rv64)
set(DRV_SOURCE_DIR /proj/alanfaascache-PG0/late_feb/new/prev_commit/drv)
set(DRV_BINARY_DIR /proj/alanfaascache-PG0/late_feb/new/prev_commit/drv/build/rv64)
set(SST_DIR /users/alanuiuc/local/sstcore/lib/cmake/SST)
...
if (NOT DEFINED ARCH_RV64)
  ...
  if (NOT TARGET drvapi)
    ...
    set_target_properties(drvapi PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES /usr/local/rv64/include
      IMPORTED_LOCATION /usr/local/rv64/lib/libdrvapi.so
  ...
  if (NOT TARGET Drv)
    ...
    set_target_properties(Drv PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES /usr/local/rv64/include
      IMPORTED_LOCATION /usr/local/rv64/lib/libDrv.so
  ...
  if (NOT TARGET pandocommand)
    ...
    set_target_properties(pandocommand PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES /usr/local/rv64/include
      IMPORTED_LOCATION /usr/local/rv64/lib/libpandocommand.so
  ...
  if (NOT TARGET pandocommand_loader)
    ...
    set_target_properties(pandocommand_loader PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES /usr/local/rv64/include
      IMPORTED_LOCATION /usr/local/rv64/lib/libpandocommand_loader.so
