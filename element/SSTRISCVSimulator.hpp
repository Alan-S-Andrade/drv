...
public:
    ...
    void visitFLD(RISCVHart &hart, RISCVInstruction &instruction) override;
...
private:
    ...
    static constexpr uint64_t MMIO_PGAS_SIT  = MMIO_BASE + 0x0030;
    static constexpr uint64_t MMIO_PGAS_PTT  = MMIO_BASE + 0x0038;
