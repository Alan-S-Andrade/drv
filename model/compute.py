...
class CoreBuilder(object):
    ...
    def system_params(self, system_builder):
        ...
        return {
            ...
            "sys_pxn_dram_ports" : system_builder.pxn.dram_banks * system_builder.pxn.effective_dram_slices(),
            "sys_pxn_dram_cache_banks" : system_builder.pxn.dram.cache_banks if isinstance(system_builder.pxn.dram, CachedDRAMBuilder) else 0,
            "sys_pxn_dram_interleave_size" : system_builder.pxn.dram.cache_line_size if system_builder.pxn.effective_dram_slices() > 1 else system_builder.pxn.dram_interleave,
