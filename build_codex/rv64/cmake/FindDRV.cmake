set(GNU_RISCV_TOOLCHAIN_PREFIX /users/alanandr/local/riscv)
set(SST_CORE_PREFIX /users/alanandr/local/sstcore)
set(SST_ELEMENTS_PREFIX /users/alanandr/local/sstelements)
set(DRV_INSTALL_PREFIX /users/alanandr/drv/build_codex/rv64-install)
set(DRV_SOURCE_DIR /users/alanandr/drv)
set(DRV_BINARY_DIR /users/alanandr/drv/build_codex/rv64)
set(SST_DIR /users/alanandr/local/sstcore/lib/cmake/SST)
...
if (NOT DEFINED ARCH_RV64)
  ...
  if (NOT TARGET drvapi)
    ...
    set_target_properties(drvapi PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES /users/alanandr/drv/build_codex/rv64-install/include
      IMPORTED_LOCATION /users/alanandr/drv/build_codex/rv64-install/lib/libdrvapi.so
  ...
  if (NOT TARGET Drv)
    ...
    set_target_properties(Drv PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES /users/alanandr/drv/build_codex/rv64-install/include
      IMPORTED_LOCATION /users/alanandr/drv/build_codex/rv64-install/lib/libDrv.so
  ...
  if (NOT TARGET pandocommand)
    ...
    set_target_properties(pandocommand PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES /users/alanandr/drv/build_codex/rv64-install/include
      IMPORTED_LOCATION /users/alanandr/drv/build_codex/rv64-install/lib/libpandocommand.so
  ...
  if (NOT TARGET pandocommand_loader)
    ...
    set_target_properties(pandocommand_loader PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES /users/alanandr/drv/build_codex/rv64-install/include
      IMPORTED_LOCATION /users/alanandr/drv/build_codex/rv64-install/lib/libpandocommand_loader.so
