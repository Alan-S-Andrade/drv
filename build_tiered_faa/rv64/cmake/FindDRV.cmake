...
set(DRV_INSTALL_PREFIX /users/alanandr/drv/.local/rv64)
set(DRV_SOURCE_DIR /users/alanandr/drv)
set(DRV_BINARY_DIR /users/alanandr/drv/build_tiered_faa/rv64)
...
if (NOT DEFINED ARCH_RV64)
  ...
  if (NOT TARGET drvapi)
    ...
    set_target_properties(drvapi PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES /users/alanandr/drv/.local/rv64/include
      IMPORTED_LOCATION /users/alanandr/drv/.local/rv64/lib/libdrvapi.so
  ...
  if (NOT TARGET Drv)
    ...
    set_target_properties(Drv PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES /users/alanandr/drv/.local/rv64/include
      IMPORTED_LOCATION /users/alanandr/drv/.local/rv64/lib/libDrv.so
  ...
  if (NOT TARGET pandocommand)
    ...
    set_target_properties(pandocommand PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES /users/alanandr/drv/.local/rv64/include
      IMPORTED_LOCATION /users/alanandr/drv/.local/rv64/lib/libpandocommand.so
  ...
  if (NOT TARGET pandocommand_loader)
    ...
    set_target_properties(pandocommand_loader PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES /users/alanandr/drv/.local/rv64/include
      IMPORTED_LOCATION /users/alanandr/drv/.local/rv64/lib/libpandocommand_loader.so
