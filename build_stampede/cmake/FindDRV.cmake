...
set(DRV_INSTALL_PREFIX /work/.local)
set(DRV_SOURCE_DIR /work2/10238/vineeth_architect/stampede3/drv_copy/drv)
set(DRV_BINARY_DIR /work2/10238/vineeth_architect/stampede3/drv_copy/drv/build_stampede)
...
if (NOT DEFINED ARCH_RV64)
  ...
  if (NOT TARGET drvapi)
    ...
    set_target_properties(drvapi PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES /work/.local/include
      IMPORTED_LOCATION /work/.local/lib/libdrvapi.so
  ...
  if (NOT TARGET Drv)
    ...
    set_target_properties(Drv PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES /work/.local/include
      IMPORTED_LOCATION /work/.local/lib/libDrv.so
  ...
  if (NOT TARGET pandocommand)
    ...
    set_target_properties(pandocommand PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES /work/.local/include
      IMPORTED_LOCATION /work/.local/lib/libpandocommand.so
  ...
  if (NOT TARGET pandocommand_loader)
    ...
    set_target_properties(pandocommand_loader PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES /work/.local/include
      IMPORTED_LOCATION /work/.local/lib/libpandocommand_loader.so
