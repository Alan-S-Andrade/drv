// bfs_sw_hw_multi_fixed3.cpp
// Multihart BFS on a 2D grid, level-synchronous, with optional self-check.
...
// Set to 1 to enable full O(N) grid verification, 0 to skip.
...
// ---------- BFS state ----------
static const int MAXN = 1000 * 100;   // adjust as needed
