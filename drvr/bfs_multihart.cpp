...
static int num_cores = 128;

// Get number of cores and compute total threads
...
static int64_t thread_phase_counter[2048]; // Support up to 2048 threads (128 cores * 16 threads)
